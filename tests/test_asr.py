...
class RmsDbfsTests(unittest.TestCase):
    ...
    def test_noise_below_threshold(self):
        ...
        self.assertLess(_rms_dbfs(chunk), -45.0)
    ...
    def test_speech_level_above_threshold(self):
        ...
        self.assertGreater(_rms_dbfs(chunk), -45.0)
